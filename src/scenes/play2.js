...
preload(){
    ...
    this.load.image("plataforma2", "public/assets/images/ground.png");
    this.load.image("fondo2", "public/assets/images/fondo.png");  
}

create(){
    const map = this.make.tilemap({ key: "mapLevel2" });
    const tilesetBelow  = map.addTilesetImage("fondo", "fondo2");
    const tilesetPlatform  = map.addTilesetImage("ground", "plataforma2");
