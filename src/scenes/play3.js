...
export class Play3 extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.image("plataforma", "public/assets/images/ground1.png");
        this.load.image("fondo", "public/assets/images/fondo1.png");  
    }
    
    create(){
        const map = this.make.tilemap({ key: "mapLevel3" });
        const tilesetBelow  = map.addTilesetImage("fondo1", "fondo");
        const tilesetPlatform  = map.addTilesetImage("ground1", "plataforma");
